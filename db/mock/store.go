...
import (
	...
	sqlc "github.com/valkyraycho/bank_project/db/sqlc"
...
func (m *MockStore) TransferTx(ctx context.Context, args sqlc.TransferTxParams) (sqlc.TransferTxResult, error) {
	m.ctrl.T.Helper()
